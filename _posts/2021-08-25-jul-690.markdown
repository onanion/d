...
---
    <div class="page-image">
      <div class="cover-image" style="background: url({{"https://cdn.javsts.com/wp-content/uploads/2021/08/jul690pl.jpg" | prepend: site.baseurl | append : page.img}}) center no-repeat; background-size: cover;"></div>
    </div>
<h2>Streaming</h2>
